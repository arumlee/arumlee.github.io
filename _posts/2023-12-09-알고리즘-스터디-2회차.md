...
결론은 2개가 똑같은거 맞다. 다만 numpy에서는 array가 따로 있다곤 하는데 그거랑은 다른 것 같다. 구글에 검색해보니 _파이썬의 list는 여러가지 자료형을 같이 써도 그게 보존되어 있지만, numpy의 array는 자료형을 하나만 쓸 수 있다고 한다. 여러가지를 같이 쓰면 문자열로 바뀐다는 내용이 있다._ 출처: https://jimmy-ai.tistory.com/90
